...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi Crazy Sir, I Need To Buy Your Paid Mr-Phyo PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        continue
                        loop+=1
                except request=s.exceptions.ConnectionError:
                        time.sleep(10)
                except Exception as e:
                        pass
